export const titleGenerationPrompt = `You are given an initial conversation from a user and an AI LLM agent. You must summarise the content in 3-4 words. Don't add a period to the end.`;
